		...
		<div class="container">
            ...
            <?php if ( have_posts() ) : while( have_posts() ) : the_post(); ?>
              <div class="single-blog">
                    ...
                    <!-- <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/blog/01.jpg" alt=""> -->
    							...
    							<div class="post-article"><?php the_excerpt(); ?></div>
